...
class GetDetails extends Component {
    ...
    handleSubmit = (e) => {
        ...
        //alert(this.state.medicalid);
        const apiUrl = 'https://onehealthdb-b32b.restdb.io/rest/medical?q={"medicalid":"' + this.state.medicalid +'"}';
        //alert(apiUrl);

        axios.get(apiUrl,{
            headers: {
                "Content-Type": "application/json",
                "x-apikey": "f225926f59d5926001dc107d68f935c4c8743"
            }
        }
